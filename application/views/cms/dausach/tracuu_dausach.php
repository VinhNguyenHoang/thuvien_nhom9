        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <!-- pagination -->
                    <div class="">
                        <a href="<?=site_url("cms/dausach/chitiet_dausach/".$tuasach['id'].'/0')?>" class="btn btn-block btn-primary">Thêm đầu sách</a> 
                    </div>
                </div>
            </div>
                        ...
                        <?php foreach($dausach as $ds):?>
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <a href="<?=site_url('cms/cuonsach/tracuu/'.$ds['id'])?>" type="button" class="btn btn-block btn-primary btn-sm">Quản lý cuốn sách</a>
                                        </div>
                                        <div class="col-md-3">
                                            <a href="<?=site_url('cms/dausach/chitiet_dausach/'.$ds['id'])?>" type="button" class="btn btn-block btn-success btn-sm">Chỉnh sửa</a>
                                        </div>
                                        <div class="col-md-3">
