        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <!-- pagination -->
                    <div class="">
                        <a href="<?=site_url("cms/cuonsach/chitiet_cuonsach/".$dausach['id'].'/0')?>" class="btn btn-block btn-primary">Thêm cuốn sách</a> 
                    </div>
                </div>
            </div>
                        ...
                        <?php foreach($cuonsach as $cs):?>
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <a href="<?=site_url('cms/cuonsach/chitiet_cuonsach/'.$dausach['id'].'/'.$cs['id'])?>" type="button" class="btn btn-block btn-success btn-sm">Chỉnh sửa</a>
                                        </div>
                                        <div class="col-md-3">
